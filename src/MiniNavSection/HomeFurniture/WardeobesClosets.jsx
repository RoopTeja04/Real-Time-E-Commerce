...
import wardrobesAndClosetsData from '../../ShopData/HomeFurniture/WardrobesClosetsData';
import { useTheme } from '../../ContextAPI/ThemeContext';

const WardeobesClosets = () => {
    ...
    const filteredData = wardrobesAndClosetsData.filter((data) => {
        ...
        <>
            <div className="min-h-screen flex flex-row w-full">
                ...
                <p className="text-lg font-semibold">Product Name</p>
                    <label>
                        <input type='checkbox' value="Godrej Interio" onChange={(e) => handleNameChange(e.target.value)} /> 
                        <span className="text-base tracking-wide pl-1">Godrej Interio</span>
                    </label>
                    <label>
                    ...
                    <label>
                        <input type='checkbox' value="20000 to 25000" onChange={(e) => handleRangeChange(e.target.value)} /> 
                        <span className="text-base tracking-wide pl-1">₹20,000 to ₹25,000</span>
                    </label>
                    <label>
...
export default WardeobesClosets