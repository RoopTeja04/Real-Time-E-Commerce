...
import STData from '../../ShopData/HomeAppliances/ST';
...
const ST = () => {
    ...
    const filteredData = STData.filter((data) => {
        ...
        <>
            <div className="min-h-screen flex flex-row w-full">
                <div className={`flex flex-col border-r-2 w-1/6 px-4 py-4 ${ theme === "Light" ? "border-white" : "border-gray-900" }`}>
                    ...
                    <label>
                        <input type='checkbox' value="Braun" onChange={(e) => handleNameChange(e.target.value)} /> 
                        <span className="text-base tracking-wide pl-1">Braun</span>
                    </label>
                    <label>
                        <input type='checkbox' value="Remington" onChange={(e) => handleNameChange(e.target.value)} /> 
                        <span className="text-base tracking-wide pl-1">Remington</span>
                    </label>
                    <label>
                        <input type='checkbox' value="Wahl" onChange={(e) => handleNameChange(e.target.value)} /> 
                        <span className="text-base tracking-wide pl-1">Wahl</span>
                    </label>
                    <label>
                        <input type='checkbox' value="Andis" onChange={(e) => handleNameChange(e.target.value)} /> 
                        <span className="text-base tracking-wide pl-1">Andis</span>
                    </label>
