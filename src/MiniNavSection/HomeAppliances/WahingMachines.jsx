...
import WashingMachinesData from '../../ShopData/HomeAppliances/Washing Machines';
import { useTheme } from '../../ContextAPI/ThemeContext';

const WahingMachines = () => {
    ...
    const filteredData = WashingMachinesData.filter((data) => {
            ...
            <div className="min-h-screen flex flex-row w-full">
                <div className={`flex flex-col border-r-2 w-1/6 px-4 py-4 ${ theme === "Light" ? "border-white" : "border-gray-900" }`}>
                    <p className="text-lg font-semibold">Product Name</p>
                        ...
                        <label>
                            <input type='checkbox' value="Intex" onChange={(e) => handleNameChange(e.target.value)} /> 
                            <span className="text-base tracking-wide pl-1">Intex</span>
                        </label>
                        <label>
                        ...
                        <label>
                            <input type='checkbox' value="Onida" onChange={(e) => handleNameChange(e.target.value)} /> 
                            <span className="text-base tracking-wide pl-1">Onida</span>
                        </label>
                        <label>
